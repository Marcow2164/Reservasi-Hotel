...
if (isset($_GET['id_fasilitas_hotel'])) {
  $id_fasilitas_hotel = ($_GET['id_fasilitas_hotel']);
  $query = "SELECT * FROM fasilitas_hotel WHERE id_fasilitas_hotel='$id_fasilitas_hotel'";
...
<head>
  ...
  <title>MyHotel | Admin - Edit Data Fasilitas Hotel</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0" style="font-family: sans-serif; font-size: 30px;"> Edit Data Fasilitas Hotel </h1>
              <hr>
            </div><!-- /.col --> 
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-outline card-dark">
              <div class="card-header">
                <h3 class="text-center" style="font-family: sans-serif; font-size: 25px;"> --- Edit Data Fasilitas Hotel --- </h3>
              </div>
              <div class="card-body">
                <form method="post" action="update_fasilitas_hotel.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label> - Keterangan</label>
                    <input name="id_fasilitas_hotel" value="<?php echo $data['id_fasilitas_hotel']; ?>" hidden>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <a href="fasilitas_hotel.php" class="btn btn-dark col-1">Cancel</a>
                      </div>
                    </div>
                </form>
              </div>
